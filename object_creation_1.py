...
class BankAccount:
    def __init__(self, account_number, balance, account_type):
        # Set instance variables for each value
...
# Call the deposit and withdraw methods on the account object
BankAccount_1.deposit(100)
BankAccount_1.withdraw(50)

# Call the display_balance method on the account object to make sure it's working correctly
